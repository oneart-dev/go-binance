...
[![Build Status](https://travis-ci.org/oneart-dev/go-binance.svg?branch=master)](https://travis-ci.org/oneart-dev/go-binance)
[![GoDoc](https://godoc.org/github.com/oneart-dev/go-binance?status.svg)](https://godoc.org/github.com/oneart-dev/go-binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/oneart-dev/go-binance)](https://goreportcard.com/report/github.com/oneart-dev/go-binance)
[![codecov](https://codecov.io/gh/oneart-dev/go-binance/branch/master/graph/badge.svg)](https://codecov.io/gh/oneart-dev/go-binance)
...
```shell
go get github.com/oneart-dev/go-binance/v2
```

For v1 API, it has been moved to `v1` branch, please use:

```shell
go get github.com/oneart-dev/go-binance/v1
```
...
```golang
import (
    "github.com/oneart-dev/go-binance/v2"
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/oneart-dev/go-binance) for full references.
